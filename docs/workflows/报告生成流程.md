...
│  │ 工具: documentReaderTool, reviewItemStorageTool              │ │
│  └─────────────────────────────────────────────────────────────┘ │
│                           │                                      │
│                           ▼                                      │
│  ┌─────────────────────────────────────────────────────────────┐ │
│  │ Step 4: content-review-agent                                 │ │
│  │ 输入: documentId, reviewItems[], responseItems[]             │ │
│  │ 输出: issues[], reviewItemResults[], responseItemResults     │ │
│  │ 工具: documentReaderTool                                      │ │
│  └─────────────────────────────────────────────────────────────┘ │
│                           │                                      │
│                           ▼                                      │
│  ┌─────────────────────────────────────────────────────────────┐ │
│  │ Step 5: image-review-agent (可选)                            │ │
│  │ 输入: documentId, image blocks                                │ │
│  │ 输出: issues[]                                                │ │
│  └─────────────────────────────────────────────────────────────┘ │
│                           │                                      │
│                           ▼                                      │
...
|------|------|---------|
| `answered` | 已响应 | 满足要求 |
| `partially_answered` | 部分响应 | 创建 issue，提示补充 |
| `unanswered` | 未响应 | 创建 issue，标记缺失 |
| `not_applicable` | 不适用 | 无 issue |
