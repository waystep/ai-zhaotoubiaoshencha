...
本项目 **智能投标预审智能体**：支持招标文件与投标文件上传、高精度解析（MinerU）、结构化区块与坐标、审查项提取、基于多智能体（Mastra）的 AI 合规审查与对话、问题清单与 PDF 精确定位、项目级统计分析。数据按 **项目（orgId）** 多项目隔离。
...
4. **多项目与可运营**：项目、文档、报告、问题与统计均按项目隔离，便于企业内推广。
