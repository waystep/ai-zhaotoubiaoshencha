...
CREATE TYPE "public"."login_method" AS ENUM('password', 'phone_sms', 'feishu_oauth', 'wechat_oauth', 'sso_saml', 'sso_oidc');--> statement-breakpoint
...
CREATE TYPE "public"."sms_purpose" AS ENUM('login', 'register', 'reset_password', 'bind_phone');--> statement-breakpoint
...
ALTER TABLE "tender_projects" ADD CONSTRAINT "tender_projects_created_by_users_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
